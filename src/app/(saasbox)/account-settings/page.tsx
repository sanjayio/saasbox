import { AccountDeletion } from "@/components/saasbox/account-settings/account-deletion";
import { AccountLinking } from "@/components/saasbox/account-settings/account-linking";
import { ChangePasswordForm } from "@/components/saasbox/account-settings/change-password-form";
import { PasskeyManagement } from "@/components/saasbox/account-settings/passkey-management";
import { ProfileUpdateForm } from "@/components/saasbox/account-settings/profile-update-form";
import { SessionManagement } from "@/components/saasbox/account-settings/session-management";
import { SetPasswordButton } from "@/components/saasbox/account-settings/set-password-button";
import { TwoFactorAuth } from "@/components/saasbox/account-settings/two-factor-auth";
