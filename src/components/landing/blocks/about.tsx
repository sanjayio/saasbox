    ...
    <section className="container mt-10 flex max-w-5xl flex-col-reverse gap-8 md:mt-14 md:gap-14 lg:mt-20 lg:flex-row lg:items-end">
      ...
      <div className="flex flex-col gap-8 lg:gap-16 xl:gap-20">
        ...
        <TextSection
          title="The team"
          paragraphs={[
            "SaaSBox was founded by Sanjay Kumar in 2025, with a passion for AI, automation, and simplifying everyday business operations. Since day one, we&apos;ve focused on rebuilding what&apos;s possible for customer communication and support.",
      ...
      <div className="flex flex-col gap-8 lg:gap-16 xl:gap-20">
        <TextSection
          paragraphs={[
            "At SaaSBox, we're driven to revolutionize how organizations engage and support their customers through AI Voice Agents and automation. Our mission is to empower you with always-on, intelligent voice-driven solutions that streamline conversations, reduce manual effort, and deliver exceptional experiences—effortlessly and at scale.",
